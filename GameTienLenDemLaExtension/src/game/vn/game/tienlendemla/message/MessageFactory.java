 ...
 */
package game.vn.game.tienlendemla.message;
...
import game.vn.game.tienlendemla.TienLenDemLaController;
...
public class MessageFactory {
     ...
     * @return
     */
    public SFSObject createMessageStopGame(String userIdCurrentPlayer, TienLenPlayer[] players, TienLenDemLaController game) {
        ...
        for (int i = 0; i < players.length; i++) {
            ...
            if (user != null) {
                ...
                playerData.putDouble("penalty", players[i].getPenalty().doubleValue());
     ...
     * @return
     */
    public SFSObject createReturnMessage(TienLenDemLaController controller, String userMover, Card[] cardMove, String currentUser, List<Card> cardsMyself,
