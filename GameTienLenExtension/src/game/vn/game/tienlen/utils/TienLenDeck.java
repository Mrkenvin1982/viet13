...
//     */
    ...
    public List<Card> getTestA1(){
        List<Card> cards = new ArrayList<>();

        cards.add(dealCard(0, 1));
        cards.add(dealCard(1, 0));
        cards.add(dealCard(2, 0));
    ...
    public List<Card> getTestB1(){
        List<Card> cards = new ArrayList<>();
        
        cards.add(dealCard(0, 0));
        cards.add(dealCard(2, 1));
    ...
    public List<Card> getTestA(){
        List<Card> cards = new ArrayList<>();

        //đôi 2, 1 rác, còn lại 1 sảnh
//        cards.add(dealCard(12, 0));
//        cards.add(dealCard(12, 1));
