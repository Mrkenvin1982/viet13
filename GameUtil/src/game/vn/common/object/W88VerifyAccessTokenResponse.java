 ...
 * @author anlh
 */
public class W88VerifyAccessTokenResponse {
...
//    public static final int VERIFY_FAILED = 15001;
    ...
    private int code;
    private W88VerifyResponseData data;
     ...
     * @return the data
     */
    public W88VerifyResponseData getData() {
        return data;
    }
     ...
     */
    public void setData(W88VerifyResponseData data) {
        this.data = data;
    }
